...
const Clients = () => {
    ...
    const onFinish = async (values) => {
        try {
            ...
            message.success("Distributor muvaffaqiyatli qo'shildi");
            // setSelectedItem("");
            form.resetFields();
            setCurrentTab("1");
        } catch (error) {
            message.error("Distributor qo'shishda xatolik: " + error.data.message);
        }
    };
    return (
        <div className='distributors'>
            ...
            >
                <Tabs.TabPane tab="Xaridorlar" key="1">
                    <Table style={{ overflowX: "auto" }} size="small" dataSource={clients} loading={isLoading} columns={columns} />
                </Tabs.TabPane>
